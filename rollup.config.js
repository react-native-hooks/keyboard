...
const standaloneBaseConfig = {
  ...
  input: './src/index.js',
  output: {
    file: 'dist/react-native-hooks-keyboard.js',
    format: 'umd',
    globals,
    name: 'react-native-hooks-keyboard',
    sourcemap: true,
  },
...
const standaloneProdConfig = {
  ...
  output: {
    ...
    file: 'dist/react-native-hooks-keyboard.min.js',
  },
...
const nativeConfig = {
  ...
  output: [
    getCJS({
      file: 'dist/react-native-hooks-keyboard.cjs.js',
    }),
    getESM({
      file: 'dist/react-native-hooks-keyboard.esm.js',
    }),
  ],
};
